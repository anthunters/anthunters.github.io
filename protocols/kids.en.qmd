...
2.  **Collecting the baits:** One hour after placing them, you will collect the baits and use the tweezers we sent you to capture between 1 and 6 worker ants of each type present per bait (ideally 6 workers of each species if available). All ants from the same bait should be preserved in a single microtube with ethanol. **NOTE:** You can look at the size, color, and shape to distinguish between different ant species.
