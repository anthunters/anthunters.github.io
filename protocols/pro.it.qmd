...
Ti invieremo un **kit con tutto il materiale necessario per partecipare**, incluso un manuale di istruzioni che potrai portare nei siti di campionamento, piastre di Petri e cotone per le esche, flaconi per l'acqua, zucchero, pipetta, pinzette, microprovette con etanolo puro per conservare i campioni, un modello per la raccolta dati e una busta preaffrancata per inviarci i campioni raccolti.

### **Dove condurre il campionamento?**

Come partecipante, collocherai esche di acqua zuccherata in due aree a tua scelta:
1. Un **parco urbano** (scegli una posizione con poco passaggio di cani o persone che potrebbero interferire con il campionamento).
2. Un'**area naturale** (bosco, prato o qualsiasi altro spazio naturale non interessato dall'intervento umano. Evita campi coltivati e ambienti seminaturali).
...
2.  **Preparazione dell'esca: cos'è un'esca in questo progetto?**
    ...
    **Prima di recarti nella tua area di campionamento**, dovresti far bollire l'acqua del rubinetto per 10 minuti e trasportarla nei 3 flaconi forniti per preparare la soluzione di acqua zuccherata (uno per ogni periodo di campionamento: mattina, pomeriggio e sera). Prima di ogni periodo di campionamento, **sul campo appena prima di iniziare il campionamento**, aggiungerai lo zucchero all'acqua (ti invieremo la quantità necessaria di zucchero da sciogliere in ciascuno dei flaconi d'acqua), agiterai delicatamente per un minuto fino a completo scioglimento e aggiungerai 2 ml di acqua zuccherata a ciascuna delle 10 esche corrispondenti.
